...
class Time {
    function getPlayerTimeByName($name, $platform, $region) {
        /**
    ...
    function getPlayerTimeById($id, $platform, $region) {
        ...
        //Prepares Utils object (we will need it to convert the player's playtime)
        $utils;
        $this->utils = new Utils();

        //Gets the necessary data from the results
        $playerPlaytime = $result['stats']['generalpvp_timeplayed'];

        //Converts seconds to Hours, Minutes and Seconds
        $truePlaytime = $this->utils->convertSecondsToPlaytime($playerPlaytime);
